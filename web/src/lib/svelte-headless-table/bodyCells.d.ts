...
export type BodyCellAttributes<
  Item,
...
export type DataBodyCellInit<
  Item,
  Plugins extends AnyPlugins = AnyPlugins,
  Value = unknown,
> = Omit<BodyCellInit<Item, Plugins>, "id"> & {
...
> extends BodyCell<Item, Plugins> {
  ...
  constructor({
    ...
    label,
    value,
  }: DataBodyCellInit<Item, Plugins, Value>)
  render(): RenderConfig
  clone(): DataBodyCell<Item, Plugins>
}
export type DisplayBodyCellInit<
  Item,
  Plugins extends AnyPlugins = AnyPlugins,
> = Omit<BodyCellInit<Item, Plugins>, "id"> & {
