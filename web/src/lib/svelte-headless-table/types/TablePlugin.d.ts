...
>
export type TransformFlatColumnsFn<Item> = (
  flatColumns: DataColumn<Item>[],
) => DataColumn<Item>[]
...
> = {
  [K in ComponentKeys]: unknown extends AttributeSet[K]
    ? never
    : AttributeSet[K]
}
...
type TablePropSetForPluginKey<Plugins extends AnyPlugins> = {
  [K in keyof Plugins]: Plugins[K] extends TablePlugin<
    any,
    any,
    any,
    infer TablePropSet
