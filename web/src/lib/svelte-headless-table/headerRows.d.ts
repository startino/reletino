...
export type HeaderRowAttributes<
  Item,
...
export declare const getHeaderRows: <
  Item,
  Plugins extends AnyPlugins = AnyPlugins,
>(
...
export declare const getHeaderRowMatrix: <
  Item,
  Plugins extends AnyPlugins = AnyPlugins,
>(
  columns: Column<Item, Plugins>[],
) => Matrix<HeaderCell<Item, Plugins>>
export declare const getOrderedColumnMatrix: <
  Item,
  Plugins extends AnyPlugins = AnyPlugins,
>(
...
export declare const headerRowsForRowMatrix: <
  Item,
  Plugins extends AnyPlugins = AnyPlugins,
>(
 ...
 */
export declare const getMergedRow: <
  Item,
  Plugins extends AnyPlugins = AnyPlugins,
>(
  cells: HeaderCell<Item, Plugins>[],
