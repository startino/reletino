...
export type HeaderCellAttributes<
  Item,
...
export type FlatHeaderCellInit<
  Item,
  Plugins extends AnyPlugins = AnyPlugins,
> = Omit<HeaderCellInit<Item, Plugins>, "colspan">
...
export type FlatDisplayHeaderCellInit<
  Item,
  Plugins extends AnyPlugins = AnyPlugins,
> = Omit<FlatHeaderCellInit<Item, Plugins>, "label"> & {
  label?: HeaderLabel<Item, Plugins>
}
...
export type GroupHeaderCellInit<
  Item,
  Plugins extends AnyPlugins = AnyPlugins,
> = Omit<HeaderCellInit<Item, Plugins>, "id"> & {
  ids: string[]
  allIds: string[]
}
...
export type GroupDisplayHeaderCellInit<
  Item,
  Plugins extends AnyPlugins = AnyPlugins,
> = Omit<GroupHeaderCellInit<Item, Plugins>, "label" | "colspan"> & {
  label?: HeaderLabel<Item, Plugins>
  colspan?: number
}
