...
export declare class DataBodyRow<
  Item,
  Plugins extends AnyPlugins = AnyPlugins,
> extends BodyRow<Item, Plugins> {
  __data: boolean
  dataId: string
  original: Item
  constructor({
  ...
  clone({
    includeCells,
    includeSubRows,
  }?: BodyRowCloneProps): DataBodyRow<Item, Plugins>
}
export type DisplayBodyRowInit<
  Item,
  Plugins extends AnyPlugins = AnyPlugins,
> = BodyRowInit<Item, Plugins>
export declare class DisplayBodyRow<
  Item,
  Plugins extends AnyPlugins = AnyPlugins,
> extends BodyRow<Item, Plugins> {
  __display: boolean
  constructor({
    ...
    depth,
    parentRow,
  }: DisplayBodyRowInit<Item, Plugins>)
  clone({
    includeCells,
    includeSubRows,
  }?: BodyRowCloneProps): DisplayBodyRow<Item, Plugins>
}
 ...
 */
export declare const getBodyRows: <
  Item,
  Plugins extends AnyPlugins = AnyPlugins,
>(
  data: Item[],
 ...
 */
export declare const getColumnedBodyRows: <
  Item,
  Plugins extends AnyPlugins = AnyPlugins,
>(
 ...
 */
export declare const getSubRows: <
  Item,
  Plugins extends AnyPlugins = AnyPlugins,
>(
  subItems: Item[],
