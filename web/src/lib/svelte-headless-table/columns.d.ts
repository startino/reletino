...
export type DataColumnInitIdAndKey<
  Item,
  Id extends string,
...
export type DisplayColumnDataGetter<
  Item,
  Plugins extends AnyPlugins = AnyPlugins,
> = (cell: DisplayBodyCell<Item>, state?: TableState<Item, Plugins>) => unknown
...
> extends FlatColumn<Item, Plugins, Id> {
  ...
  constructor({
    ...
    cell,
    data,
  }: DisplayColumnInit<Item, Plugins, Id>)
}
export type GroupColumnInit<
  Item,
  Plugins extends AnyPlugins = AnyPlugins,
> = Omit<ColumnInit<Item, Plugins>, "height"> & {
...
> extends Column<Item, Plugins> {
  ...
  constructor({
    ...
    columns,
    plugins,
  }: GroupColumnInit<Item, Plugins>)
}
export declare const getFlatColumnIds: <
  Item,
  Plugins extends AnyPlugins = AnyPlugins,
>(
  columns: Column<Item, Plugins>[],
) => string[]
export declare const getFlatColumns: <
  Item,
  Plugins extends AnyPlugins = AnyPlugins,
>(
  columns: Column<Item, Plugins>[],
